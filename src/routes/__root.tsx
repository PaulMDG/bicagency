...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Blessmarked Shop — Modern Kenyan eCommerce" },
      ...
      { name: "author", content: "Blessmarked Shop" },
      { property: "og:title", content: "Blessmarked Shop — Modern Kenyan eCommerce" },
      ...
      { name: "twitter:title", content: "Blessmarked Shop — Modern Kenyan eCommerce" },
